...
cp "$repo/scripts/run-on-pi.sh" "$repo/scripts/run-integration-on-pi.sh" "$repo/scripts/run-gp-dynrec-sweep-on-pi.sh" "$release/scripts/"
chmod +x "$release/scripts/run-on-pi.sh" "$release/scripts/run-integration-on-pi.sh" "$release/scripts/run-gp-dynrec-sweep-on-pi.sh"
